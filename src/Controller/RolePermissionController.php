...
class RolePermissionController extends BaseController
{
    ...
    public function index(Request $request, EventDispatcherInterface $dispatcher): Response
    {
        ...
        $permissionOrder = [
            ...
            new PermissionSection('Product', '_product'),
            new PermissionSection('Order', '_order'),
            new PermissionSection('Customer', '_customer'),
            new PermissionSection('Supply', '_fournisseur'),
            new PermissionSection('Employee', '_fournisseur'),
            new PermissionSection('Entrepot', '_entrepot'),
            new PermissionSection('Stock', '_stock'),
            new PermissionSection('Mouvement', '_mouvement'),
            new PermissionSection('Inventory', '_inventory'),
            new PermissionSection('Configuration', '_config'),
        ];
