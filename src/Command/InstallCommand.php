...
class InstallCommand extends Command
{
    ...
    {
        $this
            ->setName('geste:install')
            ->setDescription('Basic installation for Geste')
            ->setHelp('This command will perform the basic installation steps to get Geste up and running.');
    }

    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        $io = new SymfonyStyle($input, $output);
        $io->title('Geste installation running ...');
    ...
    protected function createKey(SymfonyStyle $style,OutputInterface $output){
